function [log_likelihood, derivative] = get_subject_clip_training_info_4opt(...
...
d_attribute_theta = 9;
d_low_theta = 5;
object_theta = reshape(full_theta(1: d_object_theta^2), d_object_theta, d_object_theta);
attribute_theta = full_theta(d_object_theta^2+1: d_object_theta^2+d_attribute_theta);
low_theta = full_theta(d_object_theta^2+d_attribute_theta+1: end);
